...
def prediction_class_knn(dist,k):
    ...
    predicted_value = new_class_list.value_counts().idxmax()
...
# tune bandwidth for Guassian kernel for regression
# https://stackoverflow.com/questions/33852388/rbf-kernel-for-classification-using-knn

# Test:
# filename="abalone.csv"
# dataset = load_dataset(filename)
# dataset = ordinal_data(dataset, ['M','F','I'])
# validation, dfs = cross_validation(dataset, 5)
# dfs[2].to_csv("fold3.csv")

# validation = validation.iloc[0:10, :]

# class_column_name= "Rings"
# numerical_column_list = ['Length', 'Diameter continuous', 'Height', 'Whole weight', 'Shucked weight', 'Viscera weight', 'Shell weight']
# predict = k_nn(3, dfs[2], validation, class_column_name, numerical_column_list, ["Sex"] , "regression")
# print(predict)